...
const drawerStuff = [
    ...
    {text:'Vault', path:'/vault', icon:LockIcon },
    {text:'Builds', path:'/builds', icon:SensorOccupiedIcon},
    {text:'Change Character', path:'/pick-character', icon:SafetyDividerIcon},
]
